...
import { getAnalytics, type SerializedAnalytics } from "@/actions/analyticsActions";
 ...
 */
export function useAnalytics(initialTimeRange: TimeRange = 7): UseAnalyticsReturn {
